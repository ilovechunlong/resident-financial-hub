    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-6">
          Please provide details for the primary emergency contact person.
        </p>
      </div>
      ...
      <div className="bg-blue-50 p-4 rounded-lg">
        ...
        <p className="text-sm text-blue-800">
          This person will be contacted in case of emergencies or if we need to discuss the resident's care. 
